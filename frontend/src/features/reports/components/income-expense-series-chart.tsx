  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <AreaChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
        ...
        <Area type="monotone" dataKey="income" name="Receita" stroke="var(--success)" strokeWidth={2} fill="url(#reportIncomeGradient)" />
        <Area type="monotone" dataKey="expense" name="Despesa" stroke="var(--danger)" strokeWidth={2} fill="url(#reportExpenseGradient)" />
      </AreaChart>
    </ResponsiveContainer>
  )
}
